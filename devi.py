...
class mentorLearner: 
	#stack of interest/expertise
	stack = []
	
	#status will determine whether the object is a learner or a mentor(0 for learner, 1 for mentor, by default it is 0)
	status = 0 
	...
	#assuming the time slots begin and end at hours corresponding to a specific integer ie. only at 2:30, not 2:30 and 24hr format is used 
	...
	#this underlying block of code was suggested by a friend of mine, I don't really understand it completely.
